...
suite('Unit Tests', () => {
    ...
    test('valid puzzle strings pass the solver', function(){
        assert.notProperty(solver.solvePuzzle('1.5..2.84..63.12.7.2..5.....9..1....8.2.3674.3.7.2..9.47...8..1..16....926914.37.'), 'error')
    })
    // #11
    test('invalid puzzle strings fail the solver', function(){
        assert.property(solver.solvePuzzle('..9..5.1.85.4....2432......1...69.83.9.....6.62.71...9......1945....4.37.4.3..8..'), 'error')
    })
    // #12
    test('returns expected solution for an incomplete puzzle', function(){
        assert.notProperty(solver.solvePuzzle('1.5..2.84..63.12.7.2..5.....9..1....8.2.3674.3.7.2..9.47...8..1..16....926914.3..'), 'error')
    })
